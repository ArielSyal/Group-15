...
//                Toast.makeText(MainActivity.this, "Add product", Toast.LENGTH_SHORT).show();
        ...
        findBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name.isEmpty() && !priceText.isEmpty()) {
                    cursor = dbHandler.findProductByNameAndPrice(name, price);
                } else if (name.isEmpty() && price != 0.0) {
                    cursor = dbHandler.findProductByPrice(price);
                } else if (!name.isEmpty()) {
                    cursor = dbHandler.findProductByName(name);
                } else {
                    Toast.makeText(MainActivity.this, "Enter name or price", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String name = productName.getText().toString();
                double price = Double.parseDouble(productPrice.getText().toString());
                dbHandler.deleteProductByNameAndPrice(name, price);
